...
private:
    ...
    static constexpr int TEMP_HIGH = 410;      // 41.0°C
    ...
    static constexpr int CURRENT_HIGH = 4000000;       // 4A
    static constexpr int CURRENT_MEDIUM = 6000000;     // 6A
    static constexpr int CURRENT_LOW = 8000000;        // 8A
